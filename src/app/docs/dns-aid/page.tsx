...
export default function DnsAidPage() {
  return (
    <article className="legal-prose mx-auto max-w-2xl px-6 py-12">
      <Link href="/docs/agents" className="text-sm font-medium text-accent-purple hover:underline">
        ← Agents &amp; API discovery
      </Link>
      <h1 className="mt-4 text-3xl font-semibold text-text">DNS-AID (DNS for AI Discovery)</h1>
      <p>
      ...
      <pre className="overflow-x-auto rounded-lg border border-card-border bg-card/80 p-4 text-xs text-text">
